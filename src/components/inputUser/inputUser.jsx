    ...
    return ( 
        <section className='w-[95%] lg:w-[50%] flex flex-col m-auto px-2 sm:px-8 gap-8 text-white'>
            ...
            <div className='w-full flex flex-col md:flex-row gap-4 md:gap-8'>
                ...
                <button type="submit" className='min-w-max min-h-[2.5rem] bg-[#E5383B] py-2 px-4 rounded-sm hover:bg-[#E5383B90] hover:scale-[1.02] transition-all duration-200' onClick={() => props.getSubmitChannel(submitChannel)}>Carregar Informações</button>
            </div>
        </section>
     );
}